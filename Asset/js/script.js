...
function mulai() {
	...
	setTimeout(function () {
		music.play()
		doorSection.css('transform', 'scale(8)')
	}, 600)
...
function toggleMusic(event) {
	...
	if (isPlaying) {
		musicButton.innerHTML = '<i class="fas fa-fw fa-pause"></li>'
		musicButton.classList.remove('rotate')
		musicButton.style.transform = 'translateY(0)'
		music.pause()
	}
	else {
		musicButton.innerHTML = '<i class="fas fa-fw fa-compact-disc"></li>'
...
//countdown weeding
var countdownDate = new Date("Feb 1, 2025 10:00:00").getTime()
...
const nama1 = urlParams.get('p')
const nama2 = urlParams.get('n')
const namaSambutan = document.querySelector('#nama-sambutan')
namaSambutan.innerText = `${nama1} ${nama2},`
